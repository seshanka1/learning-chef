...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "vseshanka-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/personal_home"
  #   chef.validation_client_name = "personal_home-validator"
  #   chef.validation_key_path = ".chef/personal_home-validator.pem"
  # end
end
